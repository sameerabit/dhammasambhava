        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex flex-wrap gap-8 text-isha-brown">
                <div class="flex items-center">
                    ...
                    <span class="font-semibold">{{ $session->duration_label }}</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 mr-2 text-isha-orange" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex items-center">
                    ...
                    @else
                    <span class="text-2xl font-bold text-isha-brown-dark">Rs. {{ number_format($session->price, 2) }}</span>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-8 sticky top-24">
                        ...
                        <div class="mb-8">
                            <div class="text-3xl font-bold text-center mb-2">
                                ...
                                @else
                                <span class="text-isha-brown-dark">Rs. {{ number_format($session->price, 2) }}</span>
                                @endif
                            </div>
                        ...
                        <div class="pt-6 border-t border-isha-cream">
                            ...
                            <x-whatsapp-button :message="'I\'m interested in ' . $session->title" class="w-full justify-center" />
                        </div>
                    </div>
                </div>
            </div>
