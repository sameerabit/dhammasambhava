...
@section('content')
<!-- Success Hero -->
<section class="bg-gradient-to-r from-green-100 to-emerald-100 py-16">
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 mb-8">
                ...
                <!-- Session Information -->
                <h2 class="text-2xl font-bold text-amber-900 mb-6">Your Booking Details</h2>

                <div class="space-y-6">
                    <!-- Session -->
                    <div class="border-b border-gray-200 pb-4">
                        <h3 class="text-sm font-semibold text-gray-500 uppercase mb-2">Session</h3>
                        <div class="flex items-center justify-between">
                            <p class="text-lg font-bold text-gray-800">{{ $booking->session->title }}</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 border-b border-gray-200 pb-4">
                        <div>
                            ...
                            <p class="text-lg text-gray-800">
                                <svg class="w-5 h-5 inline mr-2 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-gray-500 uppercase mb-2">Time</h3>
                            <p class="text-lg text-gray-800">
                                <svg class="w-5 h-5 inline mr-2 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 border-b border-gray-200 pb-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg text-gray-800">{{ $booking->session->duration }} minutes</p>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <p class="text-lg font-mono text-gray-800">#{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <h3 class="text-sm font-semibold text-gray-500 uppercase mb-2">Your Special Requests</h3>
            ...
            <!-- What's Next -->
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-8 mb-8 border-l-4 border-amber-600">
                <h2 class="text-2xl font-bold text-amber-900 mb-4">What Happens Next?</h2>
            ...
            <div class="grid md:grid-cols-3 gap-4 mb-8">
                <a href="{{ route('sessions.index') }}"
                   class="block text-center px-6 py-4 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition font-semibold">
                    Browse More Sessions
                </a>
                <a href="{{ route('home') }}"
                   class="block text-center px-6 py-4 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition font-semibold">
                    Return to Homepage
                </a>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 border-t-4 border-amber-600">
                <blockquote class="text-center">
                    ...
                    <footer class="text-amber-900 font-semibold">— Lao Tzu</footer>
                </blockquote>
            </div>
        </div>
    </div>
