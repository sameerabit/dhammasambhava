...
@section('content')
<!-- Hero Section -->
<section class="palm-leaf-bg py-20 md:py-28">
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <div class="mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-amber-900 mb-6 text-center">Our Story</h2>
...
<section class="py-16 bg-gradient-to-br from-amber-50 to-orange-50">
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 mb-12 text-center">Our Mission & Values</h2>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 mb-12 text-center">What We Offer</h2>
...
<section class="py-16 bg-gradient-to-br from-amber-50 to-orange-50">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 mb-6">Our Teachers</h2>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-amber-900 mb-8 text-center">Visit Us</h2>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-8 border-l-4 border-amber-600">
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        <svg class="w-6 h-6 mr-3 text-amber-600 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"/>
                        </svg>
                        <div>
                            <h4 class="font-bold text-gray-800 mb-1">Location</h4>
                            <p class="text-gray-700">Check individual session listings for specific locations</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-800 mb-1">When</h4>
                            <p class="text-gray-700">Sessions run throughout the week – view our schedule for specific times</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-800 mb-1">Contact</h4>
                            <p class="text-gray-700">Reach out via WhatsApp for any questions or to arrange a visit</p>
                        </div>
                    </div>
                </div>
            </div>
