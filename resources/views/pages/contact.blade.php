    ...
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-white rounded-lg shadow-xl p-8 border-t-4 border-green-600">
                    <div class="text-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-2">WhatsApp</h2>
                    ...
                    <a href="https://wa.me/1234567890?text=Hello%2C%20I%27m%20interested%20in%20learning%20more%20about%20your%20sessions"
                       target="_blank"
                       class="block w-full text-center px-6 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-bold text-lg shadow-lg">
                        Message Us on WhatsApp
                    </a>

                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <h3 class="font-semibold text-gray-800 mb-3">Best for:</h3>
                ...
                <!-- Book a Session -->
                <div class="bg-white rounded-lg shadow-xl p-8 border-t-4 border-amber-600">
                    <div class="text-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-2">Book a Session</h2>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <h3 class="font-semibold text-gray-800 mb-3">Available Sessions:</h3>
                        <ul class="space-y-2 text-gray-600 text-sm">
                            <li class="flex items-start">
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-8 border-l-4 border-amber-600">
                <h2 class="text-2xl font-bold text-amber-900 mb-6">Frequently Asked Questions</h2>

                <div class="space-y-6">
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Do I need prior experience to attend?</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">What should I bring to a session?</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Are sessions offered online?</h3>
                        <p class="text-gray-700">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">What are your payment options?</h3>
                        <p class="text-gray-700">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Can I visit before booking a session?</h3>
                        <p class="text-gray-700">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 mb-2">What if I need to cancel my booking?</h3>
                        <p class="text-gray-700">
            ...
            <div class="grid md:grid-cols-3 gap-6 mt-12">
                <a href="{{ route('quotes.index') }}"
                   class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition text-center">
                    <div class="text-4xl mb-3">📖</div>
                    <h3 class="font-bold text-gray-800 mb-2">Browse Quotes</h3>
                ...
                <a href="{{ route('gallery.teachings') }}"
                   class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition text-center">
                    <div class="text-4xl mb-3">🎥</div>
                    <h3 class="font-bold text-gray-800 mb-2">Video Teachings</h3>
